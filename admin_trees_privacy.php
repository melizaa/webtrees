...
$tags=array_unique(array_merge(
	explode(',', $WT_TREE->preference('INDI_FACTS_ADD')), explode(',', $WT_TREE->preference('INDI_FACTS_UNIQUE')),
	explode(',', $WT_TREE->preference('FAM_FACTS_ADD' )), explode(',', $WT_TREE->preference('FAM_FACTS_UNIQUE' )),
	explode(',', $WT_TREE->preference('NOTE_FACTS_ADD')), explode(',', $WT_TREE->preference('NOTE_FACTS_UNIQUE')),
	explode(',', $WT_TREE->preference('SOUR_FACTS_ADD')), explode(',', $WT_TREE->preference('SOUR_FACTS_UNIQUE')),
	explode(',', $WT_TREE->preference('REPO_FACTS_ADD')), explode(',', $WT_TREE->preference('REPO_FACTS_UNIQUE')),
...
case 'update':
	...
	$WT_TREE->preference('HIDE_LIVE_PEOPLE',           WT_Filter::postBool('HIDE_LIVE_PEOPLE'));
	$WT_TREE->preference('KEEP_ALIVE_YEARS_BIRTH',     WT_Filter::post('KEEP_ALIVE_YEARS_BIRTH', WT_REGEX_INTEGER, 0));
	$WT_TREE->preference('KEEP_ALIVE_YEARS_DEATH',     WT_Filter::post('KEEP_ALIVE_YEARS_DEATH', WT_REGEX_INTEGER, 0));
	$WT_TREE->preference('MAX_ALIVE_AGE',              WT_Filter::post('MAX_ALIVE_AGE', WT_REGEX_INTEGER, 100));
	$WT_TREE->preference('REQUIRE_AUTHENTICATION',     WT_Filter::postBool('REQUIRE_AUTHENTICATION'));
	$WT_TREE->preference('SHOW_DEAD_PEOPLE',           WT_Filter::post('SHOW_DEAD_PEOPLE'));
	$WT_TREE->preference('SHOW_LIVING_NAMES',          WT_Filter::post('SHOW_LIVING_NAMES'));
	$WT_TREE->preference('SHOW_PRIVATE_RELATIONSHIPS', WT_Filter::post('SHOW_PRIVATE_RELATIONSHIPS'));
...
>
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('REQUIRE_AUTHENTICATION', $no_yes, $WT_TREE->preference('REQUIRE_AUTHENTICATION'), 'class="radio-inline"'); ?>
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('HIDE_LIVE_PEOPLE', $disable_enable, $WT_TREE->preference('HIDE_LIVE_PEOPLE'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<?php echo select_edit_control('SHOW_DEAD_PEOPLE', $privacy, null, $WT_TREE->preference('SHOW_DEAD_PEOPLE'), 'class="form-control"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			...
			echo
				...
				'<input type="text" name="KEEP_ALIVE_YEARS_BIRTH" value="'.$WT_TREE->preference('KEEP_ALIVE_YEARS_BIRTH').'" size="5" maxlength="3">',
				'<input type="text" name="KEEP_ALIVE_YEARS_DEATH" value="'.$WT_TREE->preference('KEEP_ALIVE_YEARS_DEATH').'" size="5" maxlength="3">'
			); ?>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<?php echo select_edit_control('SHOW_LIVING_NAMES', $privacy, null, $WT_TREE->preference('SHOW_LIVING_NAMES'), 'class="form-control"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_PRIVATE_RELATIONSHIPS', $disable_enable, $WT_TREE->preference('SHOW_PRIVATE_RELATIONSHIPS'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				name="MAX_ALIVE_AGE"
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('MAX_ALIVE_AGE')); ?>"
				>
			<p class="small text-muted">
