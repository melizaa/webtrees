...
?>
<h2>
	<?php echo WT_I18N::translate('Family tree getPreference'); ?>
	—
...
<form class="form-horizontal" method="POST" role="form">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<span class="input-group-addon">
					<?php echo WT_SERVER_NAME, WT_SCRIPT_PATH; ?>index.php?ged=
				</span>
				<input
					class="form-control"
					dir="ltr"
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select id="CONTACT_USER_ID" name="CONTACT_USER_ID" class="form-control">
				<?php foreach (User::allVerified() as $user): ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select id="WEBMASTER_USER_ID" name="WEBMASTER_USER_ID" class="form-control">
				<?php foreach (User::allAdmins() as $user): ?>
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SURNAME_TRADITION', $surname_traditions, $WT_TREE->getPreference('SURNAME_TRADITION'), 'class="radio-inline" style="display: block;"'); ?>
			<p class="small text-muted">
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="GEONAMES_ACCOUNT">
			<?php echo WT_I18N::translate('Use GeoNames database for autocomplete on places'); ?>
		</label>
		<div class="col-sm-9">
			<input
				class="form-control"
